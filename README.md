...
curl -sS -X POST http://127.0.0.1:8090/v1/providers/indextts-default/clone \
  -F "audio=@speaker.wav" \
  -F "name=我的音色" \
  -F "text=参考文本" \
  -F "language=zh"
...
curl -sS -H "Content-Type: application/json" -o out.wav \
  ...
  -d '{"provider_id":"indextts-default","text":"你好","voice_id":"wo-de-yin-se"}'
```
...
curl -sS -o out.wav \
  -X POST http://127.0.0.1:8090/v1/synthesize \
  -F 'request={"provider_id":"indextts-default","text":"你好","voice_id":"index-default"}' \
...
curl -sS -H "Content-Type: application/json" -o out.wav \
  -X POST http://127.0.0.1:8090/v1/synthesize \
  -d "{\"provider_id\":\"indextts-default\",\"text\":\"你好\",\"voice_id\":\"index-default\",\"parameters\":{\"reference_audio\":\"data:audio/wav;base64,$REF_B64\"}}"
```
