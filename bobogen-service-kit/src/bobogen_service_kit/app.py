...
from bobogen_protocol.models import CloneRequest, DesignRequest, ErrorResponse, SynthesizeRequest
from bobogen_service_kit.errors import ProtocolError, map_exception
from bobogen_service_kit.reference_audio import resolve_reference_audio
...
def create_service_app(service_name: str, handler, api_key: Optional[str] = None) -> FastAPI:
    ...
    configured_api_key = api_key or os.environ.get("BOBOGEN_API_KEY") or os.environ.get("LOCAL_TTS_API_KEY")
