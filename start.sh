...
run_native() {
    ...
    case "$ACTION" in
        ...
        stop)
            echo "正在停止服务..."
            for provider in stable_audio_3_small_sfx stable_audio_3_small_music stable_audio_3_medium local_index_tts local_voxcpm local_gpt_sovits local_f5_tts local_cosyvoice2; do
