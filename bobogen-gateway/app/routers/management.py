...
MODEL_CATALOG = [
    {
        ...
        "name": "CosyVoice2",
        "task": "语音合成",
        "version": "CosyVoice2 · 0.5B",
        "purpose": "中文语音合成、预置音色和参考音频克隆",
        "weight_size": "约 2.6 GB（估算）",
    ...
    },
    {
        ...
        "name": "TIGER-DnR",
        "task": "对白/背景分离",
        "version": "源码 9f18d4a · 权重 b7a5956",
        "purpose": "把影视混音拆成对白和背景声两个音轨",
        "weight_size": "固定 revision 权重",
        "disk_estimate": "需检测 Hugging Face 缓存",
        "service_port": 5114,
