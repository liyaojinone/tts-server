...
**Files:**
- Create: `local-tts-gateway/app/adapters/indextts.py`
- Modify: `local-tts-gateway/app/services/provider_registry.py`
- Create: `local-tts-gateway/configs/providers/indextts-default.yaml`
...
Run: `python -m pytest local-tts-gateway/tests/test_config_loading.py -v`
...
- `python -m pytest local-tts-gateway/tests -v`
