...
official_model_dir="${repo_dir}/Qwen3-ASR-0.6B"
...
export QWEN3_ASR_MODEL_DIR="${QWEN3_ASR_MODEL_DIR:-${official_model_dir}}"
...
if [[ -n "${QWEN3_ASR_HF_ENDPOINT:-}" ]]; then
  export HF_ENDPOINT="${QWEN3_ASR_HF_ENDPOINT}"
fi
...
echo "Hugging Face endpoint: ${HF_ENDPOINT:-<default>}"
