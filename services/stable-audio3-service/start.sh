...
export STABLE_AUDIO3_PORT="$PORT"
...
echo "Stable Audio 3 model id: ${STABLE_AUDIO3_MODEL_ID:-}"
echo "Stable Audio 3 HF repo: ${STABLE_AUDIO3_HF_REPO_ID:-}"
echo "Stable Audio 3 test mode: ${STABLE_AUDIO3_TEST_MODE:-}"
echo "Starting stable-audio3-service on http://127.0.0.1:$PORT"
